...
ALIAS_CHECK4=$(/usr/bin/grep controlsd /system/comma/home/.bash_profile)
ALIAS_CHECK5=$(/usr/bin/grep gitpull /system/comma/home/.bash_profile)
...
if [ "$ALIAS_CHECK4" == "" ]; then
    sleep 3
    mount -o remount,rw /system
    echo "alias co='/data/openpilot/controlsd.sh'" >> /system/comma/home/.bash_profile
    mount -o remount,r /system
fi
if [ "$ALIAS_CHECK5" == "" ]; then
    sleep 3
    mount -o remount,rw /system
